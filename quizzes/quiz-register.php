           ...
           <div class="logo text-center">
            ...
            <div id="polina" class="col-sm-6">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group has-success has-feedback">
                        <div class="col-sm-12">
                            <input type="email" id="email" name="email" class="form-control" value="<?php echo isset($email) ? $email : ''; ?>" placeholder="Email">
                    ...
                    <div class="form-group">
                        <label for="upload" class="col-sm-1 control-label">Upload</label>
                        <div class="col-sm-12">
